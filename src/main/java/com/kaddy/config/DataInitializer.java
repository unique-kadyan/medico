...
public class DataInitializer {
    ...
    public CommandLineRunner initializeTestUsers() {
        return args -> {
            ...
            createDoctorIfNotExists("DOC001", "John", "Doe", "Cardiology", "LIC-12345",
                    "+91 98765 43210", "doctor@medico.com", "Cardiology", 10,
                    "MBBS, MD (Cardiology)", "Experienced cardiologist with 10 years of practice");

            createDoctorIfNotExists("DOC002", "Emily", "Smith", "Pediatrics", "LIC-67890",
                    "+91 98765 43215", "emily.smith@medico.com", "Pediatrics", 8,
                    "MBBS, DCH", "Pediatric specialist with focus on child healthcare");

            createDoctorIfNotExists("DOC003", "Michael", "Chen", "Orthopedics", "LIC-11223",
                    "+91 98765 43216", "michael.chen@medico.com", "Orthopedics", 12,
                    "MBBS, MS (Orthopedics)", "Expert in joint replacement and sports injuries");

            log.info("Test doctors initialization completed!");

            log.info("Initializing test patients...");
            createPatientIfNotExists("PAT001", "Alice", "Johnson",
                    LocalDate.of(1990, 5, 15), Gender.FEMALE, "+91 98765 43220",
                    "alice.johnson@email.com", "123 Main St, Mumbai", "Bob Johnson",
                    "+91 98765 43221", BloodGroup.A_POSITIVE, "Penicillin", "Hypertension");

            createPatientIfNotExists("PAT002", "Robert", "Williams",
                    LocalDate.of(1985, 8, 20), Gender.MALE, "+91 98765 43222",
                    "robert.williams@email.com", "456 Park Ave, Delhi", "Mary Williams",
                    "+91 98765 43223", BloodGroup.O_POSITIVE, "None", "Diabetes Type 2");

            createPatientIfNotExists("PAT003", "Sophia", "Martinez",
                    LocalDate.of(2005, 3, 10), Gender.FEMALE, "+91 98765 43224",
                    "sophia.martinez@email.com", "789 Lake Road, Bangalore", "Carlos Martinez",
                    "+91 98765 43225", BloodGroup.B_POSITIVE, "Aspirin", "Asthma");

            createPatientIfNotExists("PAT004", "James", "Davis",
                    LocalDate.of(1978, 12, 5), Gender.MALE, "+91 98765 43226",
                    "james.davis@email.com", "321 Hill Street, Chennai", "Linda Davis",
    ...
    private void createUserIfNotExists(String username, String email, String password,
        ...
        if (existingUserOptional.isEmpty()) {
            ...
            // Update existing user's password to ensure consistency in dev environment
    ...
    private void createDoctorIfNotExists(String doctorId, String firstName, String lastName,
                                          String specialization, String licenseNumber,
                                          String phone, String email, String department,
                                          Integer yearsOfExperience, String qualification, String about) {
    ...
    private void createPatientIfNotExists(String patientId, String firstName, String lastName,
                                           ...
                                           String emergencyContactPhone, BloodGroup bloodGroup,
